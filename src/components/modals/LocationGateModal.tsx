    ...
    >
      ...
      >
        ...
        <button
          ...
          aria-label={t('locationGate.close') as string}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-left">
          ...
          <button
            ...
            className={`group relative p-5 rounded-xl border text-left transition-all duration-300 hover:scale-[1.02] flex flex-col justify-between ${
              location === 'co'
          ...
          >
            <div>
              <div className="flex items-center justify-between mb-3">
                <span className="text-3xl filter drop-shadow-sm select-none" role="img" aria-label="Bandera de Colombia">
                  🇨🇴
                </span>
                <span
                  className="text-[10px] font-sans font-semibold tracking-widest uppercase px-2 py-0.5 rounded-full border"
                  style={{
              ...
              <h3 className="font-heading text-lg text-white group-hover:text-[#FAF7F2] transition-colors mb-1">
                Inner Spirit Colombia
              </h3>
              <p className="text-xs text-stone-400 font-light leading-relaxed mb-4">
                La Candelaria — Santuario matriz. Clases diarias, sound healing, consultorio y turismo andino.
              </p>
            </div>

            <div className="flex items-center text-xs font-medium tracking-wide uppercase" style={{ color: '#8B9A8B' }}>
              <span>Explorar Bogotá</span>
          ...
          >
            <div>
              <div className="flex items-center justify-between mb-3">
                <span className="text-3xl filter drop-shadow-sm select-none" role="img" aria-label="Bandeira de Portugal">
                  🇵🇹
                </span>
                <span
                  className="text-[10px] font-sans font-semibold tracking-widest uppercase px-2 py-0.5 rounded-full border"
              ...
              <p className="text-xs text-stone-400 font-light leading-relaxed mb-4">
                Costa de Leiria, perto da Nazaré. Voluntariado nómada, horta e comunidade em construção.
              </p>
            </div>
          ...
          >
            <div>
              <div className="flex items-center justify-between mb-3">
                <span className="text-3xl filter drop-shadow-sm select-none" role="img" aria-label="Flag of the United States">
                  🇺🇸
                </span>
                <span
                  className="text-[10px] font-sans font-semibold tracking-widest uppercase px-2 py-0.5 rounded-full border"
                  style={{
                    ...
                    color: '#8B9A8B',
                    background: 'rgba(77, 106, 109, 0.1)',
                  }}
                >
                  Chicago
                </span>
              ...
              <h3 className="font-heading text-lg text-white group-hover:text-[#FAF7F2] transition-colors mb-1">
                Inner Spirit Chicago
              </h3>
              <p className="text-xs text-stone-400 font-light leading-relaxed mb-4">
                Timber loft histórico. Static Dance, movimiento somático consciente y sonido 432Hz.
              </p>
            </div>

            <div className="flex items-center text-xs font-medium tracking-wide uppercase" style={{ color: '#8B9A8B' }}>
              <span>Explorar Chicago</span>
              <svg className="w-3.5 h-3.5 ml-1.5 transform group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
              </svg>
            </div>
        ...
        <p className="mt-8 text-[11px] text-stone-500 font-sans">
          {t('locationGate.footerNote') as string}
        </p>
      </div>
    </div>
  );
